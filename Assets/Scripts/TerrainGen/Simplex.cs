...
{  // Simplex noise in 2D, 3D and 4D
  ...
  138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180};
    ...
    private const double F2 = 0.5 * (1.7320508075688772935274463415059f - 1.0);
    private const double G2 = (3.0 - 1.7320508075688772935274463415059f) / 6.0;
    private const double F3 = 1.0 / 3.0;
    private const double G3 = 1.0 / 6.0;
    private const double F4 = (2.2360679774997896964091736687313f - 1.0) / 4.0;
    private const double G4 = (5.0 - 2.2360679774997896964091736687313f) / 20.0;
